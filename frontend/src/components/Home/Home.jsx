...
const Home = () => {
    const { isAuthenticated , user , signIn } = useAuthStore1();
    const handleLogin = () => {
        try {
            signIn();
    ...
    <div className="w-full md:w-1/2 flex flex-col gap-3">
        ...
        <div className='dark:text-red-600 text-lg mt-4 text-red-600 bg-red-500 bg-opacity-30 p-3 rounded-2xl flex justify-center'>* Few features won't work in testing phase *</div>
    </div>
</div>
